...
export async function analyzeDrawing(apiKey, imageBase64, mode = 'plan') {
  ...
  const prompt = mode === 'plan' 
    ? `คุณคือวิศวกรโครงสร้างผู้เชี่ยวชาญ (Senior Structural Engineer) 
       ...
       เกณฑ์การวิเคราะห์:
       1. ระบุชื่อเบอร์คาน (Label) เช่น B1, B2, GB1, B1a เป็นต้น
       2. คำนวณความยาวของคานแต่ละช่วง (Length) เป็นหน่วย "เมตร" 
       3. สำหรับคานที่ต่อเนื่องกันหลายช่วง ให้แยกแต่ละช่วงออกมาตามระยะ Grid ที่ระบุในแบบ
       4. หากมีระยะตัวเลขกำกับในแบบ (Dimension lines) ให้ใช้ค่าเหล่านั้นในการสรุป
    ...
    : `คุณคือวิศวกรโครงสร้างผู้เชี่ยวชาญ (Senior Structural Engineer)
       ...
       และสกัดข้อมูลทางวิศวกรรมสำหรับคานแต่ละประเภท
